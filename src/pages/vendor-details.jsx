    ...
    <div className="">
      ...
      <ul class="nav nav-tabs" id="myTabs" role="tablist">
        <li class="nav-item ms-4" role="presentation">
          <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true" style={{ color: "black" }}>Event Overview</a>
        </li>
        <li class="nav-item" role="presentation">
          <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false" style={{ color: "black" }}>[1000291945] PLUMBIN...</a>
        </li>
            ...
            {loading ? (
              ...
              <div className="w-100 container-fluid">
                <div className="main-content w-100 ">
                  <div
                    className="w-100  pt-2 mb-2  pe-2"
                  >
                    ...
                    <div className="card mb-5 p-3 mt-2 rounded-3 ">
                      <div className="col-12">
                        ...
                        >
                          <span id="participation-summary-icon" className="icon-1 square" style={{ marginRight: "8px" }}>
                            {publishedStages ? (
                            ...
                            <div className=" card card-body rounded-3 p-4  ">
                              ...
                              <div className="tbl-container mt-3">
                                ...
                                <table className="w-100 table">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td className="text-start" style={{ color: "#777777" }}>{data1.material_title}</td>
                                      <td className="text-start" style={{ color: "#777777" }}>{data1.status}</td>
                      ...
                      <div className="col-12 "
                        ...
                        <a
                          ...
                          style={{ fontSize: "16px", fontWeight: "normal" }}
                        >
                          <span id="terms-conditions-icon" className="icon-1 square" style={{ marginRight: "8px" }}>
                            {terms ? (
                              <i className="bi bi-dash-lg"></i>
                            ) : (
                              <i className="bi bi-plus-lg"></i>
                      ...
                      >
                        <a
                          ...
                          style={{ fontSize: "16px", fontWeight: "normal" }}
                        >
                          <span id="savings-summary-icon" className="icon-1 square" style={{ marginRight: "8px" }}>
                            {Contact ? (
                              <i className="bi bi-dash-lg"></i>
                            ) : (
                              <i className="bi bi-plus-lg"></i>
                            ...
                            <div className=" card card-body rounded-3 p-4 ">
                              ...
                              <div className="tbl-container mt-3">
                                <table className="w-100 table">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td className="text-start" style={{ color: "#777777" }}>{data1.created_by}</td>
                                      <td className="text-start" style={{ color: "#777777" }}>{data1.created_by_email}</td>
                                      <td className="text-start" style={{ color: "#777777" }}>{data1.crated_by_mobile}</td>
