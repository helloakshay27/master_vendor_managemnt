...
const DUMMY_DATA = [
  ...
  { department: 'Project Governance and IT', pqApproved: 11, nonPqApproved: 907 },
...
export const DepartmentPreQualificationChart = ({ data, onDownload, className = "" }) => {
  ...
  console.log('DepartmentPreQualificationChart - chartData.length:', chartData.length);
