...
export const QuarterWiseRegistrationChart = ({ data, onDownload, onRefresh, className = "" }) => {
  ...
  // Each bar gets ~40px wide; minimum 600px
    ...
    <div className={`card go-shadow bg-white rounded-lg ${className}`}>
      ...
      <div className="card-body" style={{ padding: '20px' }}>
        {chartData.length > 0 ? (
          ...
          <div className="text-center py-8 text-gray-500">No quarter-wise data available</div>
        )}
      </div>
    </div>
  );
