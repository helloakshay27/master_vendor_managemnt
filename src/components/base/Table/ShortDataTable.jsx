...
export default function ShortDataTable({
  ...
  //   // Block empty inputs but allow spaces
  //   if (newValue === "") {
  ...
  //   // Validation based on label
  //   if (["Freight Charge", "GST on Freight"].includes(currentLabel)) {
  //     // Allow only numbers, and allow empty (backspace) without alert
  ...
  //     )
  //   ) {
  //     // Allow spaces in the input, only letters, numbers, and spaces
  //     if (/[^a-zA-Z0-9\s]/.test(newValue)) {
  //       alert(
  //         "Please enter a valid string value (letters, numbers, and spaces only)."
  //       );
  //       return; // Stop updating if invalid
  //     }
  //   }
            ...
            >
              ...
              <td style={{ padding: "12px", color: "#777", textAlign: "left" }}>
                {row.label === "Realised Freight" ? (
                  // Make Realised Freight editable
                  <input
                    type="text"
                  ...
                  />
                ) : row.label === "Realised Freight" && counterBid ? (
                  // Non-editable for Realised Freight when counterBid is present
                  <span>
                    {showBothValues ? (
                      <>
                        <span
